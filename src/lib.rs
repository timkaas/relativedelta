...
mod tests {
    ...
    fn test_add() {
        ...
        assert_eq!(
            dt + add_1_year,
            Utc.with_ymd_and_hms(2021, month, day, hour, min, sec)
                .unwrap()
        );
        ...
        assert_eq!(
            dt + sub_1_year,
            Utc.with_ymd_and_hms(2019, month, day, hour, min, sec)
                .unwrap()
        );
        ...
        assert_eq!(
            dt + set_year,
            Utc.with_ymd_and_hms(2010, month, day, hour, min, sec)
                .unwrap()
        );
        ...
        assert_eq!(
            dt + set_year,
            Utc.with_ymd_and_hms(-1, month, day, hour, min, sec)
                .unwrap()
        );
        ...
        assert_eq!(
            dt + add_69_months,
            Utc.with_ymd_and_hms(2026, 1, day, hour, min, sec).unwrap()
        );

        let sub_6_months = RelativeDelta::with_months(-6).new();
        assert_eq!(
            dt + sub_6_months,
            Utc.with_ymd_and_hms(2019, 10, day, hour, min, sec).unwrap()
        );
        ...
        assert_eq!(
            dt + sub_47_months,
            Utc.with_ymd_and_hms(2016, 5, day, hour, min, sec).unwrap()
        );

        let add_400_days = RelativeDelta::with_days(400).new();
        assert_eq!(
            dt + add_400_days,
            Utc.with_ymd_and_hms(2021, 6, 2, hour, min, sec).unwrap()
        );

        let sub_400_days = RelativeDelta::with_days(-400).new();
        assert_eq!(
            dt + sub_400_days,
            Utc.with_ymd_and_hms(2019, 3, 25, hour, min, sec).unwrap()
        );
        ...
        assert_eq!(
            dt + pay1,
            Utc.with_ymd_and_hms(2020, 3, 31, hour, min, sec).unwrap()
        );
        ...
        assert_eq!(
            dt + pay2,
            Utc.with_ymd_and_hms(2020, 6, 30, hour, min, sec).unwrap()
        );
        ...
        assert_eq!(
            dt + pay3,
            Utc.with_ymd_and_hms(2020, 9, 30, hour, min, sec).unwrap()
        );
        ...
        assert_eq!(
            dt + pay4,
            Utc.with_ymd_and_hms(2020, 12, 31, hour, min, sec).unwrap()
        );
    }
    ...
    fn test_init_with_float() {
        ...
        let ddt =
            RelativeDelta::ysmsdshsmsssns_f(-0.42, -15.7, -12.3, -5.32, 3.14, 0.15, 22232).new();
